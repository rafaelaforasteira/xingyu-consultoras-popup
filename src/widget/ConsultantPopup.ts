...
export class XingyuConsultantPopup {
  ...
  private build() {
    ...
    overlay.innerHTML = `<section class="xingyu-consultant-popup__dialog" role="dialog" aria-modal="true" aria-labelledby="xingyu-popup-title" aria-describedby="xingyu-popup-description" tabindex="-1"><button class="xingyu-consultant-popup__close" type="button" aria-label="Fechar janela"></button><div class="xingyu-consultant-popup__brand"><img class="xingyu-consultant-popup__logo" src="${logoSrc}" alt="" width="52" height="52"></div><h2 id="xingyu-popup-title">Fale com uma consultora</h2><p id="xingyu-popup-description">Escolha uma de nossas consultoras e continue seu atendimento pelo WhatsApp.</p><div class="xingyu-consultant-popup__list" aria-live="polite"></div></section>`;
